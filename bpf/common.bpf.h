 ...
 */
static inline void
___vmlinux_h_sanity_check___(void)
{
  _Static_assert(SCX_DSQ_FLAG_BUILTIN,
                 "bpftool generated vmlinux.h is missing high bits for 64bit "
                 "enums, upgrade clang and pahole");
}

__s32 scx_bpf_create_dsq(__u64 dsq_id, __s32 node) __ksym;
__s32 scx_bpf_select_cpu_dfl(struct task_struct *p,
                             __s32 prev_cpu,
                             __u64 wake_flags,
                             bool *is_idle) __ksym;
...
void scx_bpf_dispatch_vtime(struct task_struct *p,
                            ...
                            __u64 vtime,
                            __u64 enq_flags) __ksym;
__u32 scx_bpf_dispatch_nr_slots(void) __ksym;
void scx_bpf_dispatch_cancel(void) __ksym;
bool scx_bpf_consume(__u64 dsq_id) __ksym;
__u32 scx_bpf_reenqueue_local(void) __ksym;
...
__u32 scx_bpf_nr_cpu_ids(void) __ksym __weak;
...
bool scx_bpf_test_and_clear_cpu_idle(__s32 cpu) __ksym;
__s32 scx_bpf_pick_idle_cpu(const cpumask_t *cpus_allowed, __u64 flags) __ksym;
__s32 scx_bpf_pick_any_cpu(const cpumask_t *cpus_allowed, __u64 flags) __ksym;
bool scx_bpf_task_running(const struct task_struct *p) __ksym;
__s32 scx_bpf_task_cpu(const struct task_struct *p) __ksym;
struct rq *scx_bpf_cpu_rq(__s32 cpu) __ksym;

static inline __attribute__((format(printf, 1, 2))) void
___scx_bpf_bstr_format_checker(const char *fmt, ...)
{
}
 ...
 * instead of an array of __u64. Invoking this macro will cause the scheduler to
...
/* task */
struct task_struct *bpf_task_from_pid(__s32 pid) __ksym;
...
struct cgroup *bpf_cgroup_from_id(__u64 cgid) __ksym;
...
__u32 bpf_cpumask_first(const struct cpumask *cpumask) __ksym;
...
/*
 * log2___u64 - Compute the base 2 logarithm of a 64-bit exponential value.
 * @v: The value for which we're computing the base 2 logarithm.
 */
static inline __u32
log2___u64(__u64 v)
